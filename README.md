...
| Project           | Info            |
| :------------:     | :-------------         |
| [Access](https://github.com/DavidStewartLDN/access)<br /><br /> <a href="https://github.com/DavidStewartLDN/access"><div align="center"><img src="images/access.gif" width="600" /></div></a> | <h4>Description</h4> A project I am leading to create an app to store your daily achievements.<br/><br/>Team of 6 Makers students working to create a cross-platform app to be released to the Apple and Play store in November 2020<br/><br/> This app is designed to allow the user to record their successes that would otherwise disappear in the busyness and rush of modern life. <br/><br/> Users are reminded to store their daily achievements through push notifications, with data being stored in Firebase with authentication <h4>Development</h4>React Native Expo, Firebase, Redux <h4> Testing </h4> Jest|
| [Flashcards](https://github.com/DavidStewartLDN/react-flashcards)<br /><br /> <a href="https://github.com/DavidStewartLDN/react-flashcards"><div align="center"><img src="images/flashcards.gif" width="600" /></div></a> | <h4>Description</h4> A project to show the use of React and a database<br/><br/>Timeframe: Continuous<h4>Development</h4>JavaScript, NodeJS, ReactJS |
| [FirworksBnB](https://github.com/DavidStewartLDN/fireworksBnB)<br /><br /> <a href="https://github.com/DavidStewartLDN/fireworksBnB"><div align="center"><img src="images/fireworksbnb.gif" width="600" /></div></a> | <h4>Description</h4> Team Project to create a Airbnb clone within a week time frame<br/><br/>Timeframe: 5 days <h4>Development/Testing</h4>Sinatra, Ruby <h4> Testing </h4> RSpec, Capybara |
| [Rock, Paper, Scissors](https://github.com/DavidStewartLDN/rps-challenge)<br /><br /> <a href="https://github.com/DavidStewartLDN/rps-challenge"><div align="center"><img src="images/rps.gif" width="600" /></div></a> | <h4>Description</h4> Project showing use of Sinatra and Ruby to make a simple Rock Paper Scissors application<br/><br/>Timeframe: 5 days <h4>Development/Testing</h4>Sinatra, Ruby <h4> Testing </h4> RSpec, Capybara |
| [Age UK Volunteer Matching](https://github.com/ratcliffetj/Age-UK-Volunteer-Matching)<br /><br /> <a href="https://github.com/ratcliffetj/Age-UK-Volunteer-Matching"><div align="center"><img src="images/ageUK.gif" width="600" /></div></a> | <h4>Description</h4> Second Place in Hackathon competition 'Hack for Heroes'. <br/><br/> This Project was designed to connect isolated people during the coronavirus public health pandemic with volunteers. <br/><br/> The volunteers can then connect to the vulnerable people in a similar style to an online dating app <br/><br/> Timeframe: 2 days <h4>Development</h4>Ruby on Rails, Heroku <h4> Testing </h4> TravisCI |
